    ...
    def _build_ai_prompt(self, staged_inputs: List[str], preconvert: XlsxPreconvertResult) -> str:
        ...
        lines = [
            ...
            *normalized_assets,
            ...
            "9) Use validate_migration_output to verify strict import readiness; if failed, repair and re-run validation.",
            "10) After validation passes, update checklist status before import confirmation.",
