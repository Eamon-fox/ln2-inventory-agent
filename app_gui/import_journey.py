    ...
    def _build_ai_prompt(self, staged_inputs: List[str], preconvert: XlsxPreconvertResult) -> str:
        ...
        lines = [
            ...
            *normalized_assets,
            ...
            "3) Then call fs_read to load migration_assets/schema/validation_rules.md.",
            ...
            "10) Use validate_migration_output only (do not run migration_assets/validate.py) to verify strict import readiness; if failed, repair and re-run validation.",
