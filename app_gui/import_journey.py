    ...
    def _build_ai_prompt(self, staged_inputs: List[str], preconvert: XlsxPreconvertResult) -> str:
        ...
        lines = [
            ...
            *normalized_assets,
            ...
            "11) Use validate_migration_output only to verify strict import readiness; if failed, repair and re-run validation.",
            "12) Confirm migrate/output/validation_report.json is refreshed by validate_migration_output, then update checklist status before import confirmation.",
