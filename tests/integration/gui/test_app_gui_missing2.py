"""
Module: test_app_gui_missing2
Layer: integration/gui
Covers: app_gui/plan_model.py, app_gui/workers.py, app_gui/ui/utils.py

plan_model.py 验证与渲染测试、workers.py 执行测试以及 ui/utils.py 工具函数测试
"""
