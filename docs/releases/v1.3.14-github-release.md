...
- Windows 安装包：`https://snowfox-release.oss-cn-beijing.aliyuncs.com/SnowFox-Setup-1.3.14.exe`
- macOS 安装包：`https://snowfox-release.oss-cn-beijing.aliyuncs.com/SnowFox-1.3.14-macOS.pkg`
